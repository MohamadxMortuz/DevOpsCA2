  ...
  const mockReminders: Reminder[] = [
    {
      id: '1',
      title: 'Board Meeting',
      description: 'Quarterly board meeting in the main conference room',
      reminderTime: addHours(new Date(), 2).toISOString(),
      isCompleted: false,
    ...
    },
    {
      id: '2',
      title: 'Client Call',
      description: 'Follow-up call with ABC Corp regarding project proposal',
      reminderTime: addDays(new Date(), 1).toISOString(),
      isCompleted: false,
    ...
    },
    {
      ...
      reminderTime: addDays(new Date(), 2).toISOString(),
      isCompleted: false,
    ...
    },
    {
      ...
      reminderTime: addMinutes(new Date(), 30).toISOString(),
      isCompleted: true,
    ...
    },
    {
      ...
      reminderTime: addHours(new Date(), -1).toISOString(),
      isCompleted: true,
